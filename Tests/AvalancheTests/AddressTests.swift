...
final class AddressTests: XCTestCase {
    ...
    func testCorrectEvmAddress() throws {
        ...
        XCTAssertEqual(address.address.lowercased(), "0x506433b9338e2a5706e3c0d6bce041d30688935f")
    }
    ...
    func testVerifyMessage1() throws {
        ...
        let message = Data(hex: "0x09090909")!
        ...
        XCTAssertTrue(address.verify(message: message, signature: signature))
    }
